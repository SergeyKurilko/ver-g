...
class Article(models.Model):
    ...
    views_counter = models.IntegerField(default=0, blank=True, null=True, verbose_name="Счетчик просмотров")
    rate = models.IntegerField(verbose_name='Рейтинг статьи', default=0)
